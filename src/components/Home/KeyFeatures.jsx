...
const FeaturePill = ({ label, icon: Icon, description, onHover }) => {
  return (
    <div
    ...
    >
      ...
      >
        ...
        <span className="flex h-10 w-10 items-center justify-center rounded-full bg-white border border-blue-200 transition-colors group-hover:border-blue-500">
          {/* ✅ Bigger icon without layout change */}
    ...
    <section className="w-full py-24 bg-slate-50">
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-3 big-h">Key Features</h2>
          <p className="text-slate-600 max-w-2xl mx-auto gsap-up">
        ...
        <div className="hidden md:flex items-center justify-center gap-8 relative">
          ...
          <div className="flex flex-col gap-10 items-end flex-1">
            {left.map((f) => (
              <div key={f.label} className="flex items-center gsap-up">
                <FeaturePill {...f} onHover={setActiveFeature} />
          ...
          <div className="relative flex-shrink-0">
            ...
            {activeData && (
              <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-[100%] w-[300px] z-20 rounded-xl border border-blue-200 bg-white p-4 shadow-xl text-sm">
